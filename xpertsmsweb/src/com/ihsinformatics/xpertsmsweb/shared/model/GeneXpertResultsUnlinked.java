 ...
 */
public class GeneXpertResultsUnlinked implements java.io.Serializable {
    ...
    public GeneXpertResultsUnlinked(String sputumTestId, String patientId,
	    ...
	    String expDate, String probeResultA, String probeResultB,
    ...
    public GeneXpertResultsUnlinked() {
	// Not implemented
    }

    public GeneXpertResultsUnlinked(String sputumTestId) {
	this.sputumTestId = sputumTestId;
	...
	return "cartridgeId=" + cartridgeId + ", collectedBy=" + collectedBy
		+ ", dateSubmitted=" + dateSubmitted + ", dateTested="
		+ dateTested + ", drugResistance=" + drugResistance
		+ ", errorCode=" + errorCode + ", expDate=" + expDate
		+ ", geneXpertResult=" + geneXpertResult
		+ ", instrumentSerial=" + instrumentSerial + ", isPositive="
		+ isPositive + ", laboratoryId=" + laboratoryId + ", moduleId="
		+ moduleId + ", mtbBurden=" + mtbBurden + ", pcId=" + pcId
