...
public class SputumResults implements java.io.Serializable {
    ...
    public SputumResults(String sputumTestId, String patientId,
	    String laboratoryId, int irs, int month, Date dateSubmitted,
	    Date dateTested, String testedBy, String smearResult,
	    String remarks, String otherRemarks) {
	this.sputumTestId = sputumTestId;
	this.patientId = patientId;
	...
	return sputumTestId + ", " + patientId + ", " + laboratoryId + ", "
		+ month + ", " + dateSubmitted + ", " + dateTested + ", "
		+ testedBy + ", " + smearResult + ", " + remarks + ", "
		+ otherRemarks;
    }
}
