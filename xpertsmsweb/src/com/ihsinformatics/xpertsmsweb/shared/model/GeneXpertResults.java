...
public class GeneXpertResults implements java.io.Serializable {
	...
	private Date cartridgeExpiryDate;
	...
	public GeneXpertResults(String sputumTestId, String patientId,
		...
		this.cartridgeExpiryDate = cartridgeExpiryDate;
	...
	public Date getCartridgeExpiryDate() {
		return cartridgeExpiryDate;
	}

	/**
	 * @param cartridgeExpiryDate
	 *            the expDate to set
	 */
	public void setCartridgeExpiryDate(Date cartridgeExpiryDate) {
		this.cartridgeExpiryDate = cartridgeExpiryDate;
	}
	...
	public String toString() {
		return "cartridgeId=" + cartridgeId + ", collectedBy=" + collectedBy
				...
				+ ", errorCode=" + errorCode + ", expDate="
				+ cartridgeExpiryDate + ", geneXpertResult=" + geneXpertResult
