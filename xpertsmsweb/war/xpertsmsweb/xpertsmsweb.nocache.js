...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "xpertsmsweb" because\n';
  ...
  $wnd.__gwt_activeModules['xpertsmsweb'] = {
    'moduleName' : 'xpertsmsweb',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/xpertsmsweb.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['xpertsmsweb'].superdevmode = true;

  var expectedSuffix = '/xpertsmsweb.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + xpertsmsweb + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:xpertsmsweb';
  var devModeSessionKey = '__gwtDevModeSession:xpertsmsweb';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/xpertsmsweb/xpertsmsweb.nocache.js';
  ...
  $wnd.__gwt_activeModules['xpertsmsweb'].canRedirect = true;
  $wnd.__gwt_activeModules['xpertsmsweb'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/xpertsmsweb?user.agent=' + ua + '&_callback=' + callback;
