...
public class GxVariables
{
	...
	public static final ArrayList<String>	VARIABLES					= StringUtil.toArrayList (new String[] {SAMPLE_ID, TEST_STARTED_ON, TEST_ENDED_ON, MESSAGE_SENT_ON, REAGENT_LOT_ID,
			CARTRIDGE_EXPIRATION_DATE, CARTRIDGE_SERIAL, MODULE_SERIAL, INSTRUMENT_SERIAL, MTB_RESULT_TEXT, RIF_RESULT_TEXT, HOST_ID, COMPUTER_NAME, NOTES, ERROR_CODE, ERRORNOTES, PROBEA, PROBEB,
			PROBEC, PROBED, PROBEE, PROBE_SPC, QC1, QC2, PROBEA_CT, PROBEB_CT, PROBEC_CT, PROBED_CT, PROBEE_CT, PROBE_SPC_CT, QC1_CT, QC2_CT, PROBEA_ENDPT, PROBEB_ENDPT, PROBEC_ENDPT, PROBED_ENDPT,
			PROBEE_ENDPT, PROBE_SPC_ENDPT, QC1_ENDPT, QC2_ENDPT			});
}
