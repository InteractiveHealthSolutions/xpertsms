...
public abstract class XpertResultUploadMessage
{
	...
	/**
	 * @param probeResultSpc
	 *            the probeResultSpc to set
	 */
	...
	{
		String smsText = "";
		smsText += replaceNull (sampleId) + "^" + replaceNull (mtbResult) + "^" + replaceNull (rifResult) + "^" + replaceNull (probeResultA) + "^" + replaceNull (probeResultB) + "^"
				+ replaceNull (probeResultC) + "^" + replaceNull (probeResultD) + "^" + replaceNull (probeResultE) + "^" + replaceNull (probeResultSpc) + "^" + replaceNull (probeCtA) + "^"
				+ replaceNull (probeCtB) + "^" + replaceNull (probeCtC) + "^" + replaceNull (probeCtD) + "^" + replaceNull (probeCtE) + "^" + replaceNull (probeCtSPC) + "^"
				+ replaceNull (probeEndptA) + "^" + replaceNull (probeEndptB) + "^" + replaceNull (probeEndptB) + "^" + replaceNull (probeEndptC) + "^" + replaceNull (probeEndptD) + "^"
	...
	{
		return patientId + ", " + sampleId + ", " + mtbResult + ", " + rifResult + ", " + probeResultA + ", " + probeResultB + ", " + probeResultC + ", " + probeResultD + ", " + probeResultE + ", "
				+ probeResultSpc + ", " + probeCtA + ", " + probeCtB + ", " + probeCtC + ", " + probeCtD + ", " + probeCtE + ", " + probeCtSPC + ", " + probeEndptA + ", " + probeEndptB + ", "
				+ probeEndptC + ", " + probeEndptD + ", " + probeEndptE + ", " + probeEndptSpc + ", " + qc1 + ", " + qc2 + ", " + qc1Ct + ", " + qc2Ct + ", " + qc1Endpt + ", " + qc2Endpt + ", "
				+ retries;
	}
