...
public class CsvDialog extends JDialog implements ActionListener
{
	...
	public void initComponents ()
	{
		...
		csvFolderPathTextField.setToolTipText ("Choose the folder path where you want to store CSV files. The folder must have write permissions.");
		...
		variablesList.setToolTipText ("Select all the attributes to be saved to CSV. Press Ctrl key and click multiple variables.");
		...
		fieldSeparatorComboBox.setModel (new DefaultComboBoxModel (new String[] {"COMMA", "SEMICOLON", "SPACE", "TAB", "PIPE"}));
						...
						.addGroup(topDialogPanelLayout.createSequentialGroup()
							...
							.addGroup(topDialogPanelLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(topDialogPanelLayout.createSequentialGroup()
									...
									.addGroup(topDialogPanelLayout.createParallelGroup(Alignment.LEADING)
										.addGroup(topDialogPanelLayout.createSequentialGroup()
											.addComponent(csvFolderPathTextField, 259, 259, 259)
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(selectFolderButton, GroupLayout.PREFERRED_SIZE, 32, GroupLayout.PREFERRED_SIZE))
										.addGroup(topDialogPanelLayout.createSequentialGroup()
											.addComponent(fieldSeparatorComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
											.addGap(18)
											.addComponent(useQuotesCheckBox))
										.addComponent(dateFormatComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addGroup(topDialogPanelLayout.createSequentialGroup()
											.addComponent(variablesScrollPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(descriptionScrollPanel, GroupLayout.DEFAULT_SIZE, 233, Short.MAX_VALUE))))
								.addGroup(topDialogPanelLayout.createParallelGroup(Alignment.TRAILING)
									.addGroup(topDialogPanelLayout.createParallelGroup(Alignment.LEADING, false)
										.addComponent(selectAllButton, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(selectNoneButton, Alignment.TRAILING))
			...
			topDialogPanelLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(topDialogPanelLayout.createSequentialGroup()
					...
					.addGroup(topDialogPanelLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(pathLabel)
						.addComponent(csvFolderPathTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (e.getSource () == saveButton)
		{
			...
			{
				JOptionPane.showMessageDialog (new JFrame (), "CSV Configurations have been saved successfully. Closing this dialog.", "Configuration saved!", JOptionPane.INFORMATION_MESSAGE);
				dispose ();
			}
		}
	}
