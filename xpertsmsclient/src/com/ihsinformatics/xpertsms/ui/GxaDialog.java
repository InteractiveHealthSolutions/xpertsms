...
public class GxaDialog extends JDialog implements ActionListener
{
	...
	public void initComponents ()
	{
		...
		dateFormatComboBox.setModel (new DefaultComboBoxModel (new String[] {"yyyy-MM-dd'T'HH:mm:ss'Z'", "yyyy-MM-dd hh:mm:ss", "yyyy-MM-dd", "MM/dd/yyyy hh:mm:ssa", "MM/dd/yyyy", "M/d/yy",
		...
		serverAddressTextField.setToolTipText ("Must be a valid IP address, like \"127.0.0.1\" or a URL, like \"dev.gxalert.com/api/result\". Please do not write http(s)://");
		...
		portSpinner.setToolTipText ("Port number to connect to the server. If you are not sure what this is, try 8080 or just 80, or ask your Network Admin");
						...
						topDialogPanelLayout
								...
								.addGroup (
										topDialogPanelLayout
												...
												.addGroup (
														topDialogPanelLayout.createParallelGroup (Alignment.TRAILING, false)
																.addComponent (apiKeyLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								...
								.addGroup (
										topDialogPanelLayout
												.createParallelGroup (Alignment.LEADING)
												.addComponent (apiKeyTextField, GroupLayout.PREFERRED_SIZE, 306, GroupLayout.PREFERRED_SIZE)
												.addComponent (serverAddressTextField, GroupLayout.PREFERRED_SIZE, 183, GroupLayout.PREFERRED_SIZE)
												.addComponent (portSpinner, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE)
												.addGroup (
														topDialogPanelLayout.createParallelGroup (Alignment.TRAILING, false)
																.addComponent (sslCheckBox, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																.addComponent (dateFormatComboBox, Alignment.LEADING, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
								.addContainerGap (10, Short.MAX_VALUE))
				.addGroup (
						Alignment.TRAILING,
						topDialogPanelLayout.createSequentialGroup ().addContainerGap (178, Short.MAX_VALUE).addComponent (tryButton).addPreferredGap (ComponentPlacement.RELATED)
		...
		topDialogPanelLayout.setVerticalGroup (topDialogPanelLayout.createParallelGroup (Alignment.LEADING).addGroup (
				topDialogPanelLayout
						...
						.addContainerGap ()
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (serverAddressLabel)
						...
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (portSpinner, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (usePortCheckBox))
						.addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (apiKeyTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (apiKeyLabel))
						.addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
						...
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.TRAILING).addComponent (tryButton)
										.addGroup (topDialogPanelLayout.createSequentialGroup ().addComponent (saveButton).addGap (1))).addContainerGap (40, Short.MAX_VALUE)));
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (e.getSource () == saveButton)
		{
			...
			{
				JOptionPane.showMessageDialog (new JFrame (), "GXAlert Configurations have been saved successfully. Closing this dialog.", "Configuration saved!", JOptionPane.INFORMATION_MESSAGE);
				dispose ();
			}
		}
	}
