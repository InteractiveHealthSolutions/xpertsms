...
public class OpenMrsDialog extends JDialog implements ActionListener
{
	...
	public void initComponents ()
	{
		...
		addressTextField.setToolTipText ("Must be a valid address to OpenMRS REST service, like \"/openmrs/ws/rest/v1/\". Please do not write http(s)://");
				...
				topDialogPanelLayout
						...
						.addGroup (
								topDialogPanelLayout
												...
												topDialogPanelLayout
														...
														.addGroup (
																topDialogPanelLayout
																		.createParallelGroup (Alignment.LEADING)
																		.addGroup (
																				topDialogPanelLayout.createSequentialGroup ().addComponent (addressLabel).addPreferredGap (ComponentPlacement.RELATED))
																		.addComponent (usernameLabel, GroupLayout.PREFERRED_SIZE, 141, GroupLayout.PREFERRED_SIZE)
																		.addGroup (
																				topDialogPanelLayout
																						.createParallelGroup (Alignment.TRAILING, false)
																						.addComponent (encounterTypeLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
																								Short.MAX_VALUE)
																						.addComponent (dateTimeFormatLabel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
																								Short.MAX_VALUE)))
														.addGap (6)
														.addGroup (
																topDialogPanelLayout
																		.createParallelGroup (Alignment.LEADING)
																		.addGroup (
																				topDialogPanelLayout.createParallelGroup (Alignment.TRAILING, false).addComponent (encounterTypeTextField)
																						.addComponent (dateFormatComboBox, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
																						.addComponent (sslCheckBox, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 186, GroupLayout.PREFERRED_SIZE))
																		.addGroup (
																				topDialogPanelLayout
																						.createParallelGroup (Alignment.TRAILING)
																						.addComponent (addressTextField, GroupLayout.PREFERRED_SIZE, 281, GroupLayout.PREFERRED_SIZE)
																						.addGroup (
										...
										.addGroup (
												topDialogPanelLayout.createSequentialGroup ().addGap (159).addComponent (tryButton).addPreferredGap (ComponentPlacement.RELATED)
										...
										.addGroup (
												topDialogPanelLayout.createSequentialGroup ().addContainerGap ()
														.addComponent (conceptMappingLabel, GroupLayout.PREFERRED_SIZE, 384, GroupLayout.PREFERRED_SIZE))).addContainerGap (18, Short.MAX_VALUE)));
		topDialogPanelLayout.setVerticalGroup (topDialogPanelLayout.createParallelGroup (Alignment.LEADING).addGroup (
				topDialogPanelLayout
						.createSequentialGroup ()
						.addContainerGap ()
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (addressLabel)
						...
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (usernameTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (passwordLabel)
										.addComponent (passwordField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (usernameLabel))
						.addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (dateFormatComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (dateTimeFormatLabel))
						.addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (encounterTypeTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (encounterTypeLabel))
						.addPreferredGap (ComponentPlacement.RELATED).addComponent (sslCheckBox).addGap (9).addComponent (conceptMappingLabel).addPreferredGap (ComponentPlacement.RELATED)
						.addComponent (conceptsScrollPane, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE).addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (topDialogPanelLayout.createParallelGroup (Alignment.LEADING).addComponent (saveButton).addComponent (tryButton)).addGap (11)));
	...
	public boolean validateData ()
	{
		...
		else
		{
			...
			for (String pairStr : pairs)
			{
				...
				{
					error.append (pairStr + " does not seem to be a proper map entry. Make sure it is in the format: variable=concept\n");
					valid = false;
				}
				else
				{
	...
	public void tryConfiguration ()
	{
		...
		if (validateData ())
		{
			try
			{
				// Create a REST request to OpenMRS server to look for entered EncounterType
