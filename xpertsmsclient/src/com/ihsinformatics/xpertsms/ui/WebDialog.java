...
public class WebDialog extends JDialog implements ActionListener
{
	...
	public void initComponents ()
	{
		...
		webAddressTextField.setToolTipText ("Complete web URI or servlet's address to submit requests to. For example \"http://localhost:8080/myxperthandler/xpertresults");
						...
						.addGroup (
								topDialogPanelLayout
										...
										.addGroup (
												topDialogPanelLayout
														.createSequentialGroup ()
														.addGroup (topDialogPanelLayout.createParallelGroup (Alignment.LEADING).addComponent (dateTimeFormatLabel).addComponent (encodingLabel))
														.addGap (30)
														.addGroup (
																topDialogPanelLayout
																		.createParallelGroup (Alignment.LEADING)
																		.addGroup (
																				topDialogPanelLayout.createSequentialGroup ().addComponent (utf8RadioButton)
																						.addPreferredGap (ComponentPlacement.RELATED).addComponent (utf16RadioButton))
																		.addGroup (
																				topDialogPanelLayout
																						.createSequentialGroup ()
																						.addGroup (
																								topDialogPanelLayout
																										...
																										.addGroup (
																												topDialogPanelLayout.createSequentialGroup ()
																														.addPreferredGap (ComponentPlacement.RELATED).addComponent (tryButton)
																														.addPreferredGap (ComponentPlacement.RELATED).addComponent (saveButton)))
																						.addPreferredGap (ComponentPlacement.RELATED, 148, Short.MAX_VALUE))))
										.addGroup (
												topDialogPanelLayout.createSequentialGroup ().addComponent (webAddressLabel, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE).addGap (18)
														.addComponent (webAddressTextField, GroupLayout.DEFAULT_SIZE, 270, Short.MAX_VALUE))
										.addGroup (
												topDialogPanelLayout.createSequentialGroup ()
														.addGroup (topDialogPanelLayout.createParallelGroup (Alignment.LEADING).addComponent (dataFormatLabel).addComponent (authenticationLabel))
														.addPreferredGap (ComponentPlacement.RELATED, 323, Short.MAX_VALUE))
										.addGroup (
												topDialogPanelLayout.createParallelGroup (Alignment.TRAILING, false).addComponent (scrollPane, Alignment.LEADING)
														.addComponent (parametersLabel, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 384, Short.MAX_VALUE))).addContainerGap ()));
		topDialogPanelLayout.setVerticalGroup (topDialogPanelLayout.createParallelGroup (Alignment.TRAILING).addGroup (
				topDialogPanelLayout
						.createSequentialGroup ()
						.addContainerGap (GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (webAddressLabel)
										.addComponent (webAddressTextField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap (3)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (dataFormatLabel)
										.addComponent (dataFormatComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap (7)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (authenticationLabel)
										.addComponent (authenticationComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addPreferredGap (ComponentPlacement.UNRELATED)
						.addGroup (
								topDialogPanelLayout.createParallelGroup (Alignment.BASELINE)
										.addComponent (dateTimeFormatComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addComponent (dateTimeFormatLabel))
						.addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (utf8RadioButton).addComponent (utf16RadioButton).addComponent (encodingLabel))
						.addPreferredGap (ComponentPlacement.RELATED).addComponent (parametersLabel).addPreferredGap (ComponentPlacement.RELATED)
						.addComponent (scrollPane, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE).addPreferredGap (ComponentPlacement.RELATED)
						.addGroup (topDialogPanelLayout.createParallelGroup (Alignment.BASELINE).addComponent (saveButton).addComponent (tryButton)).addGap (164)));
