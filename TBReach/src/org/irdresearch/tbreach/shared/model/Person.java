...
public class Person implements java.io.Serializable
{
	...
	public Person(String pid, String salutation, String firstName, String middleName, String lastName, String surName, String guardianName,
			char gender, Date dob, String maritalStatus, String domicile, String nic, String nicownerName, String religion, String caste,
			String roleInSystem, Boolean alive, byte[] picture)
	{
		this.pid = pid;
	...
	{
		return pid + ", " + salutation + ", " + firstName + ", " + middleName + ", " + lastName + ", " + surName + ", " + guardianName + ", "
				+ gender + ", " + dob + ", " + maritalStatus + ", " + domicile + ", " + nic + ", " + nicownerName + ", " + religion + ", " + caste
				+ ", " + roleInSystem + ", " + alive;
	}
