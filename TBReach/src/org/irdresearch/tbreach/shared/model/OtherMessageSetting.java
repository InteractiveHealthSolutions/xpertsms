...
public class OtherMessageSetting implements java.io.Serializable
{
	...
	public OtherMessageSetting(String id, String name, String districtId, String healthFacilityId, String cellNumber)
	{
		this.id = id;
		this.name = name;
	...
	{
		return id + ", " + name + ", " + districtId + ", " + healthFacilityId + ", " + cellNumber;
	}
