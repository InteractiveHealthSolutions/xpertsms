...
public class GeneXpertResultsUnlinked implements java.io.Serializable
{
	...
	public GeneXpertResultsUnlinked(String sputumTestId, String patientId, String laboratoryId, String collectedBy, Date dateSubmitted, Date dateTested,
	...
	public String toString()
	{
		return "cartridgeId=" + cartridgeId + ", collectedBy=" + collectedBy + ", dateSubmitted=" + dateSubmitted + ", dateTested="
				...
				+ ", moduleId=" + moduleId + ", mtbBurden=" + mtbBurden + ", pcId=" + pcId + ", probeCtA=" + probeCtA
