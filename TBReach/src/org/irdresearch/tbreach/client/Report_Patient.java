...
import org.irdresearch.tbreach.shared.DataType;
...
public class Report_Patient extends Composite implements IReport, ClickHandler, ChangeHandler
{
	...
	private Label						lblTbReachLog			= new Label("TB REACH Patient/Suspect Reports");
	...
	{
		String reportName = "";
		Parameter[] params = { new Parameter("UserName", TBR.getCurrentUser(), DataType.STRING) };
		try
		{
