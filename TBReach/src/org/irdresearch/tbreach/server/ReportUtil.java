...
public class ReportUtil
{
	...
	public static String generateReportFromQuery(String fileName, String query, boolean export)
	{
		try
		{
			Connection con = HibernateUtil.util.getSession().connection();
			...
			System.out.println(dest.substring(dest.lastIndexOf(File.separatorChar) + 1));
			return dest.substring(dest.lastIndexOf(File.separatorChar) + 1);
		}
		catch (Exception e)
		{
